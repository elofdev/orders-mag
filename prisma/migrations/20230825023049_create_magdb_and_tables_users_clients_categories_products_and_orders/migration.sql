...
CREATE TABLE "orders" (
    ...
    "valueWithTax" DECIMAL(65,30) NOT NULL,
    "valueWithoutTax" DECIMAL(65,30) NOT NULL,
    "totalValueWithTax" DECIMAL(65,30) NOT NULL,
    "totalValueWithoutTax" DECIMAL(65,30) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
